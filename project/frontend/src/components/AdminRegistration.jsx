...
<h2 className="text-lg font-semibold mb-4">انتخاب جنسیت</h2>
<div className="flex gap-2">
  <div className="flex gap-2 items-center">
    <input
      ...
      required
      className="appearance-none h-5 w-5 border border-customfour rounded-full checked:bg-customtwo checked:border-transparent focus:outline-none focus:ring-2 focus:ring-customfour hover:ring-2 hover:ring-customtwo transition duration-200"
    />
    <label className="text-gray-700 ml-2">مرد</label>
  </div>
  <div className="flex gap-2 items-center">
    <input
      type="radio"
      ...
      className="appearance-none h-5 w-5 border border-customfour rounded-full checked:bg-customtwo checked:border-transparent focus:outline-none focus:ring-2 focus:ring-customfour hover:ring-2 hover:ring-customtwo transition duration-200"
    />
    <label className="text-gray-700 ml-2">زن</label>
  </div>
  <div className="flex gap-2 items-center">
    <input
      type="radio"
      ...
      className="appearance-none h-5 w-5 border border-customfour rounded-full checked:bg-customtwo checked:border-transparent focus:outline-none focus:ring-2 focus:ring-customfour hover:ring-2 hover:ring-customtwo transition duration-200"
    />
    <label className="text-gray-700 ml-2">متفرق</label>
  </div>
</div>
</div> */}